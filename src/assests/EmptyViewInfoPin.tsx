export default function EmptyViewInfoPin() {
  return (
    <svg
      width='48'
      height='48'
    ...
    >
      <g opacity='0.2'>
        <g filter='url(#filter0_d_63_6315)'>
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result='effect1_dropShadow_63_6315'
          />
          <feBlend
            mode='normal'
            in='SourceGraphic'
            in2='effect1_dropShadow_63_6315'
            result='shape'
          />
        </filter>
      </defs>
