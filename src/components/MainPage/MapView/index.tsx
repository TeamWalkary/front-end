...
// mapRef.current.setBounds(bounds);
  ...
  function displayMarker(map: any, locPosition: any) {
    ...
    const iwContent = '<div style="padding:5px;">현재위치에 핀을 찍을수있어요!</div>' // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
   ...
   // 마커에 마우스오버 이벤트를 등록합니다
    window.kakao.maps.event.addListener(currentMarker, 'mouseover', function() {
    ...
    window.kakao.maps.event.addListener(currentMarker, 'click', function(mouseEvent:any) {        
